...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/vikashkumarsingh21', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/vikas-kumar-0803r/', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/vikashsingh_21/', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/vikashkumar118/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:vk0102103@gmail.com', label: 'Email' },
  ];

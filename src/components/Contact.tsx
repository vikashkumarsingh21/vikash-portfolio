...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "vk0102103@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 9473263768" },
    { icon: MapPin, label: "Location", value: "Rajkot, Gujarat, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/vikashkumarsingh21" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/vikas-kumar-0803r/" },
    { icon: Mail, url: "mailto:vk0102103@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+919473263768" },
    { icon: Instagram, url: "https://www.instagram.com/vikashsingh_21/" },
  ];

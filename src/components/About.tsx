...
<p>
  I'm <strong>Vikas Kumar</strong>, a B.Tech student specializing in
  <strong> Artificial Intelligence & Machine Learning</strong> at
  Marwadi University, Rajkot. I am passionate about building intelligent
  systems that solve real-world problems using AI, Machine Learning,
  IoT, and Full-Stack Development.
</p>

<p>
  Over the past two years, I have worked on multiple projects including
  smart agriculture systems, IoT-based automation solutions, AI
  assistants, and computer vision applications. My focus is on combining
  innovation with practical implementation to create technology that
...
<div className="about-highlights">
  ...
  <ul>
    <li>2 Internships Completed (Deloitte & SpaceECE India Foundation)</li>
    <li>Microsoft Certified: Azure AI Fundamentals</li>
    <li>Smart India Hackathon Participant</li>
    <li>Patent Published</li>
    <li>Hands-on Experience in Python, Machine Learning, IoT, Firebase, React, and APIs</li>
  </ul>
</div>

<p>
  Currently, I am seeking internship and collaboration opportunities
  where I can contribute my skills, learn from industry professionals,
  and build impactful AI-driven solutions.
</p>
            </div>
          </div>
        </div>
      ...
      <div className={`about-hobbies ${hobbiesVisible ? "hobbies-show" : "hobbies-hidden"}`}>
        ...
        <div className="hobby-grid">
          ...
          <div className="hobby">💹 Finance</div>
          <div className="hobby">🍳 Cooking </div>
        </div>
      </div>
    </section>
  );
